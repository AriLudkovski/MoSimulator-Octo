...
namespace Prefabs.Reefscape.Robots.Mods.OPJITB._2910000
{
    public class JackInTheBot : ReefscapeRobotBase
    {
        ...
        [SerializeField] private OPJITBSetpoint stowSetpoint;
        [SerializeField] private OPJITBSetpoint coralStowSetpoint;
        [SerializeField] private OPJITBSetpoint algaeStowSetpoint;
        [SerializeField] private OPJITBSetpoint groundCoralIntakeSetpoint;
        [SerializeField] private OPJITBSetpoint groundAlgaeIntakeSetpoint;
        [SerializeField] private OPJITBSetpoint stationCoralIntakeSetpoint;
        [SerializeField] private OPJITBSetpoint stackAlgaeIntakeSetpoint;
        [SerializeField] private OPJITBSetpoint l4Setpoint;
        [SerializeField] private OPJITBSetpoint l4BackSetpoint;
        [SerializeField] private OPJITBSetpoint l4BackPlaceSetpoint;
        [SerializeField] private OPJITBSetpoint bargeSetpoint;
        [SerializeField] private OPJITBSetpoint bargePlaceSetpoint;
        [SerializeField] private OPJITBSetpoint l3Setpoint;
        [SerializeField] private OPJITBSetpoint l3BackSetpoint;
        [SerializeField] private OPJITBSetpoint highAlgaeSetpoint;
        [SerializeField] private OPJITBSetpoint highAlgaeBackSetpoint;
        [SerializeField] private OPJITBSetpoint l2Setpoint;
        [SerializeField] private OPJITBSetpoint l2BackSetpoint;
        [SerializeField] private OPJITBSetpoint lowAlgaeSetpoint;
        [SerializeField] private OPJITBSetpoint lowAlgaeBackSetpoint;
        [SerializeField] private OPJITBSetpoint l1Setpoint;
        [SerializeField] private OPJITBSetpoint l1VertSetpoint;
        [SerializeField] private OPJITBSetpoint l1HighSetpoint;
        [SerializeField] private OPJITBSetpoint processorSetpoint;
        [SerializeField] private OPJITBSetpoint climbSetpoint;
        [SerializeField] private OPJITBSetpoint climbedSetpoint;
        ...
        private void FixedUpdate()
        {
            ...
            // if (CurrentSetpoint is ReefscapeSetpoints.Climb or ReefscapeSetpoints.Climbed) elevator.SetPidConstants();
            ...
            if (CurrentIntakeMode == ReefscapeIntakeMode.L1)
            {
                topIntakeRoller.gameObject.SetActive(false);

            }
            else
            {
                topIntakeRoller.gameObject.SetActive(true);
            }

            _previousSetpoint = CurrentSetpoint;
            if (CurrentSetpoint is ReefscapeSetpoints.Climb or ReefscapeSetpoints.Climbed) DriveController.SetDriveMp(0.8f);
        ...
        private IEnumerator PlaceGamePiece(ReefscapeSetpoints lastSetpoint, GamePieceState readState)
        {
            ...
            {
                force = FacingReef ? new Vector3(0, 0, -10) : new Vector3(0, 0, 10);
        ...
        private IEnumerator RotateArmFirst(OPJITBSetpoint setpoint)
        {
        ...
        private void SetSetpoint(OPJITBSetpoint setpoint)
        {
            targetArmAngle = setpoint.armAngle;
            targetWristAngle = setpoint.wristAngle;
            targetArmDistance = setpoint.armDistance;
